...
{
    private final static String INFO_TYPE_FIELD_NAME = "infoType";
    ...
    {
        Class cls = json.getAsJsonObject().get(INFO_TYPE_FIELD_NAME).getAsInt() == 0 ? VillageBuildingInfo.class : DefensiveTowerInfo.class;
    ...
    public JsonElement serialize(BuildingInfo src, Type typeOfSrc, JsonSerializationContext context)
    {
        ...
        retVal.add(INFO_TYPE_FIELD_NAME, new JsonPrimitive(src instanceof VillageBuildingInfo ? 0 : 1));
        return retVal;
    }
}
